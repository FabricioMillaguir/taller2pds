...
public class CreateTallerAplicado1Data {
	public void createTestData() throws PersistentException {
		...
		try {/*
			...
			orms.Servicio lormServicio = orms.ServicioDAO.createServicio();
			lormServicio.setTipo_servicio("gas");
			lormServicio.setUnidad_de_medida("cm3");
			lormServicio.setCargo_fijo(3000);
			lormServicio.setValor_unitario(20);
			orms.ServicioDAO.save(lormServicio);

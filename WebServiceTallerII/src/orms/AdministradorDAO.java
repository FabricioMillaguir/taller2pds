...
public class AdministradorDAO {
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Administrador) session.load(orms.Administrador.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Administrador) session.get(orms.Administrador.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.load(orms.Administrador.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.get(orms.Administrador.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryAdministrador(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From orms.Administrador as Administrador");
		if (condition != null)
	...
	public static Administrador createAdministrador() {
		return new orms.Administrador();
	}
	
	public static boolean save(orms.Administrador administrador) throws PersistentException {
		try {
			orms.TallerAplicado1PersistentManager.instance().saveObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orms.Administrador administrador) throws PersistentException {
		try {
			orms.TallerAplicado1PersistentManager.instance().deleteObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orms.Administrador administrador)throws PersistentException {
		try {
			orms.Login[] lLogins = administrador.login.toArray();
	...
	public static boolean deleteAndDissociate(orms.Administrador administrador, org.orm.PersistentSession session)throws PersistentException {
		try {
			orms.Login[] lLogins = administrador.login.toArray();
			for(int i = 0; i < lLogins.length; i++) {
				lLogins[i].setAdministrador(null);
	...
	public static boolean refresh(orms.Administrador administrador) throws PersistentException {
		try {
			orms.TallerAplicado1PersistentManager.instance().getSession().refresh(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orms.Administrador administrador) throws PersistentException {
		try {
			orms.TallerAplicado1PersistentManager.instance().getSession().evict(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();

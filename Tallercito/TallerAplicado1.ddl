...
CREATE TABLE Servicio (id int NOT NULL, tipo_servicio varchar(5) NOT NULL, valor_unitario int NOT NULL, valor_fijo int NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE Consumo (id int NOT NULL, consumo int NOT NULL, monto int NOT NULL, pagado bit NOT NULL, morosidad bit NOT NULL, fecha_vencimiento varchar(25) NOT NULL, Cuentaid int NOT NULL, Loginid int NOT NULL, PRIMARY KEY (id));
...
EXEC sp_addextendedproperty @NAME = N'MS_Description', @VALUE = 'monto consumido', @LEVEL0TYPE = N'Schema', @LEVEL0NAME = 'dbo', @LEVEL1TYPE = N'Table', @LEVEL1NAME = 'Consumo', @LEVEL2TYPE = N'Column', @LEVEL2NAME = 'monto';
...
EXEC sp_addextendedproperty @NAME = N'MS_Description', @VALUE = 'Morosidad del consumo si o no', @LEVEL0TYPE = N'Schema', @LEVEL0NAME = 'dbo', @LEVEL1TYPE = N'Table', @LEVEL1NAME = 'Consumo', @LEVEL2TYPE = N'Column', @LEVEL2NAME = 'morosidad';

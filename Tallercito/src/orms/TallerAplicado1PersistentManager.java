...
public class TallerAplicado1PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "TallerAplicado1";
	...
	private TallerAplicado1PersistentManager() throws PersistentException {
	...
	public Configuration createConfiguration() {
		...
		configuration.addAnnotatedClass(orms.Cliente.class);
		configuration.addAnnotatedClass(orms.Cliente_historico.class);
		configuration.addAnnotatedClass(orms.Cuenta.class);
		configuration.addAnnotatedClass(orms.Login.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new TallerAplicado1PersistentManager();
		}
